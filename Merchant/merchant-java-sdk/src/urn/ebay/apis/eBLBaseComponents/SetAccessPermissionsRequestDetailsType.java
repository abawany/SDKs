...
The used to decide SkipLogin allowed or not.
	...
	public void setRequiredAccessPermissions(List<String> value) {
		this.RequiredAccessPermissions = value;
	}
	...
	public void setOptionalAccessPermissions(List<String> value) {
		this.OptionalAccessPermissions = value;
	}
